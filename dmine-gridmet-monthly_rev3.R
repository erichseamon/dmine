...
systen("mkdir commodity_csv")
system("mkdir month_positive")
system("mkdir commodity_csv_agr")
system("mkdir commodity_csv_agr_month")
...
setwd(paste("/dmine/data/USDA/agmesh-scenarios/", scen_state, "/month", sep=""))
