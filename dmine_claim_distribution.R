...
#-by month
boxplot(claims ~ month, data = newmat5a, names =c("J", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D"), ylab = "claim frequency", xlab = "Months", las = 2, main= "Idaho Claim Frequency by Month, 2010-2015")
