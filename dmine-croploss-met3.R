...
if (N1 > '2000') {
  ...
  #for (i in yearspan) {
   for (p in listercomb) {
    ...
    wheatdroughtclaim_allall_drought <- subset(wheatdroughtclaim_allall_comm, damagecause == "Drought")
    ...
    wlc <- rbind(wheatclaimcountsum2007, wheatclaimcountsum2008, wheatclaimcountsum2009, wheatclaimcountsum2010, wheatclaimcountsum2011, wheatclaimcountsum2012, wheatclaimcountsum2013, wheatclaimcountsum2014, wheatclaimcountsum2015)
    ...
    wheatclaimcounttotal <- rbind(wheatclaimcounttotal2007, wheatclaimcounttotal2008,wheatclaimcounttotal2009, wheatclaimcounttotal2010, wheatclaimcounttotal2011, wheatclaimcounttotal2012, wheatclaimcounttotal2013, wheatclaimcounttotal2014, wheatclaimcounttotal2015)
    
    
    finalz <- cbind(climmeanlongterm1, wls, wla, wlc, wheatclaimcounttotal)
