getTMMX <- function(states, startDate, endDate){
  ...
  fabric <- webdata(url = 'http://thredds.northwestknowledge.net:8080/thredds/dodsC/agg_met_tmmx_1979_CurrentYear_CONUS.nc', 
                    variables = "daily_max_temperature", 
  ...
  TMMXData <- merge(counties, precipData_result_frame, by="FIPS")
