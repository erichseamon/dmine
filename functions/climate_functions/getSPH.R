getSPH <- function(states, startDate, endDate){
  ...
  fabric <- webdata(url = 'http://thredds.northwestknowledge.net:8080/thredds/dodsC/agg_met_sph_1979_CurrentYear_CONUS.nc', 
                    variables = "daily_mean_specific_humidity", 
  ...
  SPHData <- merge(counties, precipData_result_frame, by="FIPS")
