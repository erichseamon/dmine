getFM1000 <- function(states, startDate, endDate){
  ...
  fabric <- webdata(url = 'http://thredds.northwestknowledge.net:8080/thredds/dodsC/agg_met_fm1000_1979_CurrentYear_CONUS.nc', 
  ...
  colnames(precipData_result_frame) <- c("dead_fuel_moisture_1000hr")
  ...
  FM1000Data <- merge(counties, precipData_result_frame, by="FIPS")
